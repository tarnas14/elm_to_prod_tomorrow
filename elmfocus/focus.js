...
var _user$project$Main$todos = _elm_lang$core$Native_Platform.incomingPort(
	'todos',
...
var _user$project$Main$done = _elm_lang$core$Native_Platform.outgoingPort(
	'done',
	function (v) {
		return v;
	});
				...
				return {
					...
					_0: _user$project$Main$Model(
						A2(
							...
							model.todos)),
					_1: _user$project$Main$done(_p1)
				};
		}
	});
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$todos(_user$project$Main$Focus);
};
